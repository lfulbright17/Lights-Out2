...
Before you could even say anything, Ms. Light uttered in a low, scratchy voice, 'Ah, I've been waiting for you. I'm going out of town tomorrow night, and I need you to watch my house for me...
...
Ms Light's house is scenery in Ms Light's Driveway. Ms Light's house is undescribed. The description is "Ms. Light's tiny house at the end of the culdesac looks about as decrepit and off-putting as she does. You are a bit nervous as you have never been inside before. Go North through Front Door and into Entrance Room."

House is scenery in Ms Light's Driveway. house is undescribed. The description is "Ms. Light's tiny house at the end of the culdesac looks about as decrepit and off-putting as she does. You are a bit nervous as you have never been inside before. Go North through Front Door and into Entrance Room."

Player is in Ms Light's Driveway

North of Ms Light's Driveway is Entrance Room. 

Entrance Room is a room. The description of Entrance Room is "You have opened the front door and are in the house's first room. As you reach to the side of the door for the lights and flip the switch, you realize that the power must have gone out sometime during the storm. It's too dark to see, so you can't tell what the purpose of the room is. You need to find a way to turn the lights back on.
...
For now, you can try navigate your way through the house by going North, East, and West." Instead of smelling entrance room: say "A faint smell of mildew lingers. You smell something else, too-- animal hair? It seems to be coming from a Large Object in the middle of the room." Instead of listening to entrance room: say "You hear the muffled sound of the rain outside. Then, what sounded like quick footsteps moving somewhere below you. Maybe you just imagined it." 

Large object is an object. Instead of taking large object: say "It's way too big." Large object is in entrance room. large object is undescribed. Description is "A large object. It's hard to examine it using only sight in this darkness." Instead of touching large object: say "The large object is almost twice as big as you. It's soft and cushy. You bumped into a hard object next to the large object." Instead of smelling large object: say "The smell of mildew is overpowering."

Hard object is an object. Instead of taking hard object: say "It's way too big." Hard object is in Entrance room. Hard object is undescribed. Description is "A large object. It's hard to examine it using only sight in this darkness." Instead of touching hard object: say "After examining the hard object through touch, you have discovered that it has a square, flat surface that is parallel to the ground. On the surface is a small box."

Box is a thing. Box is in entrance room. box is undescribed. Description is "An object that's in the shape of a box. It's hard to examine it using only sight in this darkness." Instead of touching box: say "You feel a small switch on the side of the box." Instead of taking box: say "You shouldn't take any of Ms. Light's stuff. Who knows what she'd do to you if she noticed any of her things were missing!" Instead of listening to box: say "A bone-chilling music piece begins to play from what sounds like a piano. The unknown vocalist sings about drowning in a bathtub along to a sad melody. 'Turn the faucet,' the ghastly voice croons. Did Ms. Light compose this?" 
...
East room is a room. East room is east of entrance room. Description is "Going East, you travel down a flight of stairs. You assume that you must be in the basement. The generator should be in here somewhere." Instead of smelling room: say "You notice an odd metallic smell coming from somewhere in the room." Instead of listening to east room: say "At first the room is completely silent. Then, out of nowhere you hear a single high-pitched sound coming from the middle of the room. It definitely sounds like a piano."

Piano is a thing. Piano is in East room. it is undescribed. Description of piano is "After a quick search of the room, you find large piano resting solemnly in the center. From what you can tell, there is nothing else in the room." Instead of touching piano: say "You can easily find the keys C, D, E, F, G, A, B on the keyboard. With a brief brush of your fingertips, you can feel a sticky liquid on the keys.
